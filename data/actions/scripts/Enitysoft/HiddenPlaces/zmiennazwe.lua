local wall = 8523 -- id ściany która znika
local pos = Position(136, 94, 8) -- pozycja ściany
local time = 3 * 1000 -- na ile ma znikać 
local msg = 'wiadomosc' -- wiadomosc nad uzytym przedmiotem
local msg2 = 'otwarte' -- wiadomosc nad znikajaca sciana
