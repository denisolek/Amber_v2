local showItem = 1546 -- id przedmiotu ktory ma sie pojawic (schodow)
local pos = Position(171, 127, 7) -- pozycja przedmiotu (schodow)
local time = 10 * 1000 -- na ile mają się pojawiać
local msg = 'przejście zamkniete' -- wiadomosc nad uzytym przedmiotem
