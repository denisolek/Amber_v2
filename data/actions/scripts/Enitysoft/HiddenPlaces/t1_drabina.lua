local showItem = 1386 -- id przedmiotu ktory ma sie pojawic (schodow)
local pos = Position(150, 159, 7) -- pozycja przedmiotu (schodow)
local time = 5 * 1000 -- na ile mają się pojawiać
local msg = 'Ooo ladder !' -- wiadomosc nad uzytym przedmiotem
