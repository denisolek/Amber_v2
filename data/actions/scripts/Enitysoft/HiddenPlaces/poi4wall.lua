local wall = 1025 -- id ściany która znika
local pos = Position(176, 199, 11) -- pozycja ściany
local time = 600 * 1000 -- na ile ma znikać 
local msg = 'WALL destroyed, hurry up !' -- wiadomosc nad uzytym przedmiotem
local msg2 = 'OPENED' -- wiadomosc nad znikajaca sciana
local fromItem = 5474 -- dzwignia w lewo
local toItem = 5474 -- dzwignia w prawo
