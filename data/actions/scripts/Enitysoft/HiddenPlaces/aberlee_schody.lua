local showItem = 5259 -- id przedmiotu ktory ma sie pojawic (schodow)
local pos = Position(34, 122, 7) -- pozycja przedmiotu (schodow)
local time = 5 * 1000 -- na ile mają się pojawiać
local msg = 'Ooo stairs !' -- wiadomosc nad uzytym przedmiotem
