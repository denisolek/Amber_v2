...
function onSay(player, words, param) 
    ...
    if player:getStorageValue(836) < 0 then
        player:sendTextMessage(MESSAGE_STATUS_WARNING, "Training voucher disabled.")
    else
        player:sendTextMessage(MESSAGE_STATUS_WARNING, "Training voucher active for: " .. string.diff(player:getStorageValue(836) - os.time()))
    end
